    ...
    <div className="bg-noir min-h-screen font-sans">
      ...
      <div className="relative h-[70vh] md:h-[90vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-noir/60 flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="mt-3 text-base sm:text-lg lg:text-2xl text-rose drop-shadow-lg">
            L'art de sublimer vos mains.
          </p>
          <a
            href="#booking"
            className="mt-6 bg-gold text-noir py-2 px-6 sm:py-3 sm:px-8 rounded-full text-sm sm:text-base font-semibold shadow-lg hover:bg-rose transition"
          >
            Réservez maintenant
          </a>
        </div>
      ...
      <section id="services" className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gold text-center mb-8">
          Nos Prestations
        </h2>
